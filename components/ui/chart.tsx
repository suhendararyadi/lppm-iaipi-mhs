...
// Diperbaiki: Mendefinisikan tipe props secara eksplisit
...
interface ChartTooltipContentProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  nameKey?: string;
  labelKey?: string;
  formatter?: (value: string | number, name: string, item: TooltipItemPayload, index: number, payload: TooltipItemPayload[]) => React.ReactNode;
  labelFormatter?: (label: string | number, payload: TooltipItemPayload[]) => React.ReactNode;
...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      // Diperbaiki: Menambahkan pengecekan tipe sebelum memanggil labelFormatter
      if (labelFormatter && payload && (typeof value === 'string' || typeof value === 'number')) {
        return (
